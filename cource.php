 ...
 for ($i = 0; $i <$num_rows ; $i++){
	  list($id, $cource_name, $cource_price, $cource_description) = product_data($array[$i]);
            ...
            <div class="wrapper pad_bot2">
              <figure class="left marg_right1"><img src="admin/inventory_images/products/<?php echo $array[$i] ?>/<?php echo $array[$i] ?>.jpg"  height="150" width="250" /></figure>
              <p class="pad_bot1 pad_top2"><strong><?php echo $cource_name;?></strong> <br>
