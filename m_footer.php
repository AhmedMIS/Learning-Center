          ...
          <div class="pad_left1">
            <div class="wrapper">
              ...
              <article class="col_2 pad_left2">
                <h3>Join In:</h3>
                <ul class="list2">
                  <li><a href="/lc/teacher/">Teacher</a></li>
                  <li><a href="/lc/student/">Student </a></li>
              ...
              <article class="col_3 pad_left2">
                ...
                <ul class="list2">
                  ...
                  <a href="register.php" class="button"><span><span><strong>Subscribe</strong></span></span></a>
                </form>
              </article>
            </div>
            <div class="wrapper">
              ...
              <article class="col_4 pad_left2">Copyright &copy; <a href="#">Domain Name</a> All Rights Reserved<br>
                Design by <a target="_blank" href="">Students</a></article>
            </div>
          </div>
        </div>
      </div>
