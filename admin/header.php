        ...
        <div id="menu">
        	<ul>
            	<li><a href="index.php">Dashboard</a></li>
               	<li><a href="#">Add  &#9662;</a>
                	<ul>
                       	<li><a href="view_products.php">Manage Books and Cources</a></li>
                        <li><a href="add_Cources.php">Add Cources</a></li>
                ...
                <li><a href="c_teachers.php">Assing Teachers</a></li>
                           
                <li><a href="m_teacher.php">Manage Teacher</a></li>
                     <li><a href="">Time Table</a>                     <ul>
                       	<li><a href="timetable.php">Create Time Table</a></li>
                          	<li><a href="m_timetable.php">Manage Time Table</a></li>
                        </ul>
                        </li>
